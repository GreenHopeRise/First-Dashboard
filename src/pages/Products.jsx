...
import { MdAddCircleOutline, MdAssignmentAdd, MdOutlineDeleteSweep } from "react-icons/md";
const Products = () => {
  ...
  return (
    <div className="overflow-x-auto bg-gray-50 rounded-lg shadow-md p-6">
      <h2 className="font-bold text-3xl mb-6 text-gray-800 ">Products</h2>
      <input
        type="text"
        placeholder="Enter name or catagory"
        onChange={(e) => setQuery(e.target.value)}
        value={query}
        className="border border-gray-300 focus:right-2 focus:ring-blue-400 focus:border-blue-400 px-4 py-3 mb-6 rounded-md transition duration-200"
      />
      <table className="min-w-full bg-white border border-gray-200 rounded shadow-xl">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th
              className="px-6 py-3  border-b border-gray-300 text-left text-sm font-semibold text-gray-700 cursor-pointer hover:text-blue-600"
              onClick={sortByName}
            >
              Name {sortAsc ? "↑" : "↓"}
            </th>
            ...
            >
              ...
              <td className="px-6 py-4 border-b border-gray-200">
                <div className="flex gap-3">
                  ...
                  {/* Delete Button */}
                  <button
                    className="p-2 cursor-pointer rounded-full bg-red-100 text-red-600 hover:bg-red-200 transition"
                    title="Delete"
      ...
      <div className="mt-8">
        ...
        >
          ...
          />
          <button type="submit"
          className="border-none  rounded-full p-3 bg-green-200 hover:bg-green-300 ">
            <MdAddCircleOutline className="size-6 text-green-800"/>
          </button>
        </form>
      </div>
    </div>
